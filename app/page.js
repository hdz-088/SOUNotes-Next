...
export default function Home() {
  return (
    <div className="container mx-auto px-4 max-w-6xl py-12">
      <div className="text-center mb-12"> <h1 className="text-4xl font-bold text-gray-800 dark:text-gray-200 font-syne"> Get All Your <font color="#ce9fc1">Material</font> at One Spot </h1> <p className="mt-4 text-lg text-gray-500 dark:text-gray-300"> This site contains BCA Study Materials of Silver Oak University </p> <p className="text-lg text-gray-500 dark:text-gray-300"> In More Beautiful and Reader Friendly Format Consider Leaving <a href="/about"> {" "} <u>Feedback</u> </a> </p> </div>
