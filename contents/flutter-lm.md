       ...
       Widget build(BuildContext context) {
         return MaterialApp(
           home: Scaffold(
             appBar: AppBar(
               backgroundColor: Colors.teal,
               title: const Text('Experiment 07: Displaying Images form local and network sources'),
             ),
             body: Center(
               child: Column(
                 mainAxisAlignment: MainAxisAlignment.center,
...
**Aim:** Create form in Flutter, implementing Text input , drop-down lists, and more form elements in forms.
